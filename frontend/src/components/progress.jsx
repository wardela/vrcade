...
<div className="main-texts">
  <p className="title">Weekly Progress</p>
  <p className={`change ${scoreChange >= 0 ? 'up' : 'down'}`}>
...
const StyledWrapper = styled.div`
  ...
  .card-charts {
    width: 100%;
    height: 100%;
    background: radial-gradient(ellipse at center, #03102f, #000000);
    border-radius: 16px;
    display: flex;
  ...
  .main-texts .title {
    background-image: linear-gradient(to top left,rgb(14, 45, 146),rgb(0, 174, 255), #a6a6a6);
...
.main-texts .change {
  ...
  text-shadow: 0 0 8px #5ce1e6, 0 0 16px #5ce1e6;
...
.main-texts .down {
  color: #e65353;
  text-shadow: 0 0 8px #e65353, 0 0 16px #e65353;
}
