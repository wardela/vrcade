        ...
        <div className="canvas">
          ...
          <div id="card">
            <div className="card-content">
              ...
              <p id="prompt">View Milestones</p>
<div className="title">
  <div style={{ fontSize: '14px', lineHeight: '1.9', padding: '60px 10px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '8px', color: 'white' }}>
  {/* ✅ Completed */}
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: '8px'}}>
    ...
    Assessment Retaken after Weak Score
  </div>
</div>
</div>
