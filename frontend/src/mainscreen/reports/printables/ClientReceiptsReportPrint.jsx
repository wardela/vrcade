...
const ClientReceiptsReportPrint = forwardRef(
  ({ rows, dateFrom, dateTo, totalSum, totalCount, company, clientName }, ref) => {
            ...
            <div className="border border-gray-300 rounded-sm overflow-hidden">
              <table className="w-full text-right border-collapse">
                <thead className="bg-gray-100 border-b border-gray-400">
                  <tr>
                    <th className="py-2 px-3 font-semibold">رقم السند</th>
                    <th className="py-2 px-3 font-semibold">التاريخ</th>
                    <th className="py-2 px-3 font-semibold">المبلغ</th>
...
export default ClientReceiptsReportPrint;
