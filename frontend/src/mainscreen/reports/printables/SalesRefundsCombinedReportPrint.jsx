...
const SalesRefundsCombinedReportPrint = forwardRef(
  ({ company, dateFrom, dateTo, rows, totalSum, totalCount }, ref) => {
    // If no invoice has any refund_total > 0, hide refund columns entirely
      ...
      >
        ...
        <div className="mb-5 flex justify-center">
          <div className="flex items-center gap-4 px-4 py-1.5 border border-gray-500 rounded-md text-[12px] text-gray-800 tracking-wide">
            <span className="font-bold whitespace-nowrap">تقرير المبيعات والمرتجعات</span>
            ...
            <tbody>
              {(rows || []).map((r) => (
                <tr key={r.invoice_number} className="border-t">
                  ...
                  <td className="py-2 px-3 text-start">{r.client || "-"}</td>
...
export default SalesRefundsCombinedReportPrint;