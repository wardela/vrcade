...
const RefundsByClientReportPrint = forwardRef(
  ({ rows, dateFrom, dateTo, totalSum, totalCount, company, client }, ref) => {
  ...
  <div className="mb-3 flex justify-center">
    ...
    >
      ...
      <div className="flex items-center gap-2 text-gray-700">
        <span className="text-semibold whitespace-nowrap">
          العميل : {client?.name}
        </span>
      </div>
      <span className="font-bold whitespace-nowrap">|</span>
              ...
              <table className="w-full text-right border-collapse">
                <thead className="bg-gray-100 border-b border-gray-400">
                  <tr>
                    ...
                    <th className="py-2 px-3">رقم الفاتورة الأصلية</th>
...
export default RefundsByClientReportPrint;
