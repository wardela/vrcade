...
const SummaryMetricsTable = ({ summary, t }) => (
  <div className="mb-3 overflow-hidden rounded-sm border border-gray-300">
    ...
    {soldItems.length === 0 ? (
      ...
      <table className="print-table w-full border-collapse text-[9px]">
        <thead className="border-b bg-gray-50">
          <tr>
            <th className="w-[40%] px-2 py-1.5 text-start font-semibold">
              {t("POSMonitor.table.item")}
            </th>
            <th className="w-[12%] px-2 py-1.5 text-center font-semibold">
              {t("POSMonitor.table.qty_sold")}
            </th>
            <th className="w-[18%] px-2 py-1.5 text-end font-semibold">
              {t("POSMonitor.table.total_sales")}
            </th>
            <th className="w-[15%] px-2 py-1.5 text-center font-semibold">
              {t("POSMonitor.table.tokens_per_item")}
            </th>
            <th className="w-[15%] px-2 py-1.5 text-end font-semibold">
...
const PrintHeader = ({ company, reportTitle, textAlign, t, showSessionTag, sessionId }) => (
  <>
    <div className="mb-3 flex items-start justify-between border-b border-gray-400 pb-4">
      ...
      {company?.tax_number && (
        <div className={`${textAlign} rounded-md border border-gray-300 px-5 py-3`}>
          <p className="mb-1 text-xs text-gray-600">{t("POSMonitor.print.tax_number")}</p>
    ...
    <div className="mb-4 flex justify-center">
      <div className="flex items-center gap-4 rounded-md border border-gray-500 px-4 py-1.5 text-[12px] tracking-wide text-gray-800">
        <span className="whitespace-nowrap font-bold">{reportTitle}</span>
        {showSessionTag ? (
          <>
...
const PrintFooter = ({ t }) => (
  <div className="print-footer mt-6 border-t border-gray-300 py-2" dir="ltr">
...
const PrintSheet = ({ children, dir }) => (
  <div dir={dir} className="print-sheet bg-white font-sans text-[10px] text-gray-900">
  ...
  return (
    <>
      <PrintSheet dir={pageDir}>
        ...
        <div className="print-keep-together mb-3 mt-5 border-b border-gray-300 pb-2">
        ...
        {posSummaries.length === 0 ? (
          <div className="print-keep-together rounded-sm border border-dashed border-gray-300 px-4 py-5 text-center text-[10px] text-gray-500">
        ...
        >
          ...
          <section className="print-keep-together">
            <div className="mb-2 flex items-center justify-between border-b border-gray-200 pb-1.5">
              <div className="text-[11px] font-bold text-gray-900">{getPosLabel(posSummary, t)}</div>
...
const SingleSessionPrint = ({ session, company, pageDir, textAlign, t }) => {
  ...
  return (
    <div
      dir={pageDir}
      className="page bg-white font-sans text-[10px] text-gray-900"
      style={{
        width: "210mm",
        minHeight: "297mm",
        overflow: "hidden",
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="absolute bottom-[8mm] left-[8mm] right-[8mm] border-t border-gray-300 bg-white py-2"
            dir="ltr"
          >
            <div className="flex items-center justify-center gap-2 text-center text-[11px] text-gray-700">
              <span className="text-gray-500">{t("POSMonitor.print.powered_by")}</span>
...
function CellLabel({ children }) {
  return (
    <td className="whitespace-nowrap border-s border-gray-300 bg-gray-50 px-2 py-1.5 font-semibold text-gray-700">
      {children}
    </td>
  );
}
