...
const fetchGeneralSales = async (newOffset = 0) => {
  ...
  try {
    ...
    const res = await api.get(
      `/api/portal/reports/sales/general`,
      {
        params: {
          from: dateFrom,
          to: dateTo,
...
const fetchSalesByClient = async (newOffset = 0) => {
  ...
  try {
    ...
    const res = await api.get(
      `/api/portal/reports/sales/by-client`,
      {
        params: {
          from: dateFrom,
          to: dateTo,
...
const fetchSalesByArea = async (newOffset = 0) => {
  ...
  try {
    ...
    const res = await api.get(
      `/api/portal/reports/sales/by-area`,
      {
        params: {
          from: dateFrom,
          to: dateTo,
...
const fetchSalesByClientDetailed = async (newOffset = 0) => {
  ...
  try {
    ...
    const res = await api.get(
      `/api/portal/reports/sales/by-client-detailed`,
      {
        params: {
          from: dateFrom,
          to: dateTo,
...
const fetchItemsSoldForClientTotals = async (newOffset = 0) => {
  ...
  try {
    ...
    const res = await api.get(
      `/api/portal/reports/sales/items-by-client-totals`,
      {
        params: {
          from: dateFrom,
          to: dateTo,
