...
const InvoiceTaxSummaryReportPrint = forwardRef(
  ({ company, dateFrom, dateTo, reportData }, ref) => {
      ...
      >
        ...
        <div className="mb-5 flex justify-center">
          <div className="flex items-center gap-4 rounded-md border border-gray-500 px-4 py-1.5 text-[12px] tracking-wide text-gray-800">
            <span className="whitespace-nowrap font-bold">تقرير ضريبة الفواتير</span>
          ...
          <table className="w-full border-collapse text-sm">
            <thead className="border-b bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-start">إجمالي الفاتورة</th>
                <th className="px-3 py-2 text-start">إجمالي الضريبة</th>
              </tr>
            </thead>
            <tbody>
              {rows.length === 0 ? (
              ...
              <tr className="border-t bg-gray-50 font-semibold">
                ...
                <td className="px-3 py-2 text-end" dir="ltr">
                  {fmt3(totals.invoice_total)}
                </td>
                <td className="px-3 py-2 text-end" dir="ltr">
                  {fmt3(totals.total_tax)}
                </td>
              </tr>
            </tbody>
          </table>
...
export default InvoiceTaxSummaryReportPrint;
