...
const StorageTransactionsReportPrint = forwardRef(
  (
    {
      rows,
      company,
...
<div className="border border-gray-300 rounded-sm overflow-hidden">
  <table className="w-full text-right border-collapse table-fixed">
    <thead className="bg-gray-100 border-b border-gray-400">
      <tr>
        <th className="py-2 px-3 whitespace-nowrap">التاريخ</th>
        <th className="py-2 px-3 whitespace-nowrap">الصنف</th>
        <th className="py-2 px-3 whitespace-nowrap">المستودع</th>
        <th className="py-2 px-3 text-center whitespace-nowrap">الحركة</th>
        <th className="py-2 px-3 text-right whitespace-nowrap">الكمية</th>
        <th className="py-2 px-3 text-center whitespace-nowrap">الوحدة</th>
        <th className="py-2 px-3 whitespace-nowrap">المرجع</th>
      </tr>
    </thead>
    ...
    <tbody>
      {pageRows.map((r, i) => (
        ...
        >
          {/* Date */}
          <td
            className="py-2 px-3 whitespace-nowrap overflow-hidden text-ellipsis font-mono"
            dir="ltr"
          >
            {r.date}
          </td>
          ...
          {/* Direction */}
          <td
            className="py-2 px-3 text-center whitespace-nowrap font-medium"
          >
            {DIR_AR[r.direction] || r.direction}
          </td>

          {/* Quantity */}
          <td
            className="py-2 px-3 text-right whitespace-nowrap font-semibold font-mono"
            dir="ltr"
          >
          ...
          {/* Reference */}
          <td
            className="py-2 px-3 whitespace-nowrap overflow-hidden text-ellipsis font-mono text-xs"
            title={r.ref || "-"}
          >
            {r.ref || "-"}
          </td>
...
export default StorageTransactionsReportPrint;
