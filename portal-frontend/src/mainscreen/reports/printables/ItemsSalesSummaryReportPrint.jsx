...
const ItemsSalesSummaryReportPrint = forwardRef(
  (
    {
      rows,
      dateFrom,
              ...
              <table className="w-full text-right border-collapse">
                <thead className="bg-gray-100 border-b border-gray-400">
                  <tr>
                    ...
                    <th className="py-2 px-3 text-right">الكمية المباعة</th>
                    <th className="py-2 px-3 text-right">إجمالي المبيعات</th>
                  </tr>
                </thead>
...
export default ItemsSalesSummaryReportPrint;
