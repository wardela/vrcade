...
const SalesByClientReportPrint = forwardRef(
  (
    {
      rows,
      dateFrom,
...
<div className="flex justify-between items-start pb-4 mb-3 border-b border-gray-400">
  ...
  <div className="mb-3 flex justify-center">
    ...
    >
      {/* Report name */}
      <span className="font-bold whitespace-nowrap text-md">
      ...
      <div className="flex items-center gap-2 text-gray-700">
        ...
        <span dir="ltr" className="font-sans text-gray-900">
         {client?.name}
        </span>
        </div>
      {/* Soft separator */}
              ...
              <table className="w-full text-right border-collapse">
                <thead className="bg-gray-100 border-b border-gray-400">
                  <tr>
                    ...
                    <th className="py-2 px-3 font-semibold text-center">طريقة الدفع</th>
...
export default SalesByClientReportPrint;
